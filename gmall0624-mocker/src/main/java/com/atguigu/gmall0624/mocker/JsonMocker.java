package com.atguigu.gmall0624.mocker;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.atguigu.gmall0624.mocker.util.*;
...
public class JsonMocker {
    ...
    public JsonMocker(String startTimeString, String endTimeString, int startupNum, int eventNum) {
        ...
        logDateUtil = new RandomData(startTime, endTime, startupNum + eventNum);
    }
